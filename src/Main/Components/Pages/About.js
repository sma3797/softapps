              ...
              return (
                <div key={i} className={classes.ourServicesItemDiv}>
                  ...
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <p className={classes.ourServicesItemDivText}>
                      {service.title}
                    </p>
                  </div>
                </div>
        ...
        <div className={classes.whoWeAreContentMainDiv}>
          ...
          <div className={classes.whoWeAreContentRighttDiv}>
            <p>
              ...
              is a Canadian-based sofware development company, with branches
              extended to the US and Pakistan. We are a complete cycle
              application development company, starting from scratch, leading to
              the initial idea, landing to application design, providing quality
              assurance examination and deployment along with further
              maintenance.
            </p>
          </div>
        </div>
          ...
          <div className={classes.whyUsContentLeftDiv}>
            ...
            <div>
              <div>
                <div>
                  <h3>
                    We are an off-shore software agency, having our approach to
                    the US and Pakistan.
                  </h3>
                </div>
                <div>
                  <p>
                    We aim to provide innovative and creative solutions by doing
                    an in-depth analysis of your problem. We started this
                    company with a mission to become one of the top leading IT
                    Solution Companies.
                  </p>
                </div>
              </div>
              <div style={{ marginTop: "3rem" }}>
                ...
                <div>
                  <p>
                    We transform your ideas into digital means. A user-friendly
                    and engaging interface will help you in grabbing clients
                  </p>
                </div>
              </div>
              <div style={{ marginTop: "2rem" }}>
                ...
                <div>
                  <p>
                    We believe in result. We assist our clients through our
                    platform while building creative solutions for consistent
              ...
              <div style={{ marginTop: "2rem" }}>
                ...
                <div>
                  <p>
                    Our dedicated team has a vast experience regarding the
                    services we provide. We take a fresh start for our every
                    project, toil on it, and come up with consistent results.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={classes.whyUsContentRighttDiv}>
            <div className={classes.whyUsContentRighttDivImagesTilesMainDiv}>
              ...
              <div
                ...
                className={classes.whyUsContentRighttDivImagesTilesDiv}
              >
              ...
              >
                <img
                  src={ResultOrientedProjects}
                  alt="Result Oriented Projects"
                />
              </div>
              <div
            ...
            <div style={{ transform: "translateY(80px)" }}>
              <div>
                ...
                <p>
                  Always there for you. One of our representative will always
                  here to solve your queries.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  Softapps.io team has always grown with the modernizing era.
                </p>
              </div>
            </div>
          </div>
